...
public class Invoice {
    ...
    public Invoice(Long id, LocalDateTime date, String name, String email, String phone, String address, double subtotal, double discount, double taxRate, double taxAmount, double total, double paid, double due, String invoiceNumber) {
        this.id = id;
        this.date = date;
        this.name = name;
        this.email = email;
